...
#define DISPLAY_CLASS DISPLAY_CLASS
#define POWER_CLASS POWER_CLASS
...
const int BATTERY_PERCENT_X = 188; // 电池百分比X坐标 - 向左移动以避免百分号回行
...
// 2. 统一输入机制：由于外层 loop 已有 `UPDATE_CLASS` 读取状态，因此所有判断基于轮询直接处理。
